...
const CYBLE_CUSTOMS_T cyBle_customs[0x01u] = {
    ...
    /* Custom Uart Tx Service service */
    {
        0x000Cu, /* Handle of the Custom Uart Tx Service service */ 
        {

            /* Custom Buffer characteristic */
            {
                0x000Eu, /* Handle of the Custom Buffer characteristic */ 
